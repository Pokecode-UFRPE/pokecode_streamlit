...
with st.expander("KNN com clusterização"):
    ...
    pokemon_choose = st.selectbox('Pokémon de Referência [Com cluster] ', pokemon_df['name'],
...
with st.expander("KNN sem clusterização"):
    pokemon_choose = st.selectbox('Pokémon de Referência [Sem cluster]', pokemon_df['name'],
                                  help='Selecione um Pokémon que você gosta')
